...
'
'
    WordBasic.FormatStyle Name:="我的正文", NewName:="", BasedOn:="", NextStyle:= _
        "", Type:=0, FileName:="", Link:=""
    WordBasic.FormatStyle Name:="我的正文", NewName:="", BasedOn:="", NextStyle:= _
        "", Type:=0, FileName:="", Link:=""
    With ActiveDocument.Styles("我的正文").Font
        .NameFarEast = "宋体"
    ...
    End With
    With ActiveDocument.Styles("我的正文").ParagraphFormat
    ...
    End With
    ActiveDocument.Styles("我的正文").NoSpaceBetweenParagraphsOfSameStyle = False
    ActiveDocument.Styles("我的正文").ParagraphFormat.TabStops.ClearAll
    With ActiveDocument.Styles("我的正文").ParagraphFormat
        With .Shading
        ...
        End With
    End With
    ActiveDocument.Styles("我的正文").LanguageID = wdSimplifiedChinese
    ActiveDocument.Styles("我的正文").NoProofing = False
    ActiveDocument.Styles("我的正文").LanguageID = wdSimplifiedChinese
    ActiveDocument.Styles("我的正文").NoProofing = False
    ActiveDocument.Styles("我的正文").Frame.Delete
    ...
    With ActiveDocument.Styles("标题 2").ParagraphFormat
        ...
        .BaseLineAlignment = wdBaselineAlignAuto
    End With
    ActiveDocument.Styles("标题 2").NoSpaceBetweenParagraphsOfSameStyle = False
    ...
    With ActiveDocument.Styles("标题 3").ParagraphFormat
        ...
        .BaseLineAlignment = wdBaselineAlignAuto
    End With
    ActiveDocument.Styles("标题 3").NoSpaceBetweenParagraphsOfSameStyle = False
    With ActiveDocument.Styles("标题 3")
        .AutomaticallyUpdate = False
        .BaseStyle = "正文"
        .NextParagraphStyle = "我的正文"
    End With
